        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-bold text-gray-900">Tyab EL Assil</span>
            </div>
      ...
      <section id="about" className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">À Propos de Tyab EL Assil</h2>
            <div className="max-w-3xl mx-auto">
              <p className="text-lg text-gray-600 leading-relaxed">
                Tyab EL Assil est une initiative marocaine qui allie tradition culinaire et modernité pour rendre l’alimentation saine accessible, pratique et abordable.
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="mt-6 text-center">
                <Badge className="bg-gradient-to-r from-yellow-400 to-orange-500 text-white px-4 py-2 text-sm font-semibold">
                  🎉 Offre Spéciale : -15% avec le code Tyab EL Assil
                </Badge>
              </div>
            </div>
          </div>
  ...
  <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="space-y-12">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">Pourquoi Choisir Tyab EL Assil ?</h2>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-8">
            <Button
              ...
              onClick={() => window.open(" https://www.instagram.com/tyab_el_assil/profilecard/?igsh=b3A4dzRrZmFvdzNq ", "_blank")}
            >
              <Instagram className="h-4 w-4 mr-2" />
              Suivre @TYAB_EL_ASSIL
            </Button>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-gray-900 text-white py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-2xl font-bold">Tyab EL Assil</span>
              </div>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center">
            <p className="text-gray-400">© 2024 Tyab EL Assil. Tous droits réservés. Fait avec ❤️ au Maroc.</p>
          </div>
        </div>
      </footer>
    </div>
